...
class StatsCommandHandlerTests(unittest.IsolatedAsyncioTestCase):
    async def test_stats_without_args_starts_interactive_league_selection(self) -> None:
        ...
        with patch("interfaces.telegram.handlers.stats.get_tracking_service", return_value=tracking_service):
    ...
    async def test_stats_command_uses_unified_report_from_matches(self) -> None:
        ...
        with patch("interfaces.telegram.handlers.stats.get_stats_service", return_value=stats_service), patch(
    ...
    async def test_link_stats_links_by_statshub_url(self) -> None:
        ...
        with patch("interfaces.telegram.handlers.stats.get_stats_service", return_value=stats_service):

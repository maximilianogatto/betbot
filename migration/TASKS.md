...
| PR2-E2-S3 | Implementar adapter de suscripciones y settings de chat. | `adapters/storage/subscriptions.py`, `tests/adapters/storage/test_subscriptions_repository.py` | Cubre suscripciones chat↔liga, toggles de odds/reminders, stats-only, peak digest y `chat_settings`; operaciones por `chat_id` son idempotentes; tests cubren enabled/disabled y remoción. | PR2-E2-S0, ports PR2-F2 | IN_PROGRESS @gemini (2026-06-29) |

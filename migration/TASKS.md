...
| PR2-E2-S5 | Implementar adapter de links de estadísticas. | `adapters/storage/stats_links.py`, `tests/adapters/storage/test_stats_links_repository.py` | Liga odds↔stats y match odds↔stats se pueden listar/upsert/consultar por provider; constraints evitan duplicados; tests cubren relink and lookup por evento. | PR2-E2-S0, ports PR2-F2 | IN_PROGRESS @gemini (2026-06-29) |

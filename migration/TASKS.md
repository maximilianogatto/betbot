...
| PR1-T2 | Tope FIFO de 200 filas en `stats_payload_cache` (además del TTL). | `storage/tracking_repository.py` | Tras insertar, si hay >200 filas se borran las más viejas. Test que lo verifica. | — | IN_PROGRESS @gemini (2026-06-25) |

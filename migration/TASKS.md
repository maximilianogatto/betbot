...
| PR2-E2-S6 | Implementar adapter de live watch. | `adapters/storage/live_watch.py`, `tests/adapters/storage/test_live_watch_repository.py` | Cubre altas, listados, remoción, settings, expiración y marcas de fired/countdown/prematch; tests validan estados activos/expirados y actualización de plataforma. | PR2-E2-S0, ports PR2-F2 | IN_PROGRESS @gemini (2026-06-29) |

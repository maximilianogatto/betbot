...
| PR2-E2-S9 | Crear facade de storage y cortar imports legacy. | `adapters/storage/__init__.py`, composition root actual, tests de integración storage | Facade compone S1-S7 e implementa los ports necesarios; imports de runtime/services apuntan al facade nuevo; suite verde con DB greenfield; `storage/tracking_repository.py` queda sin uso y solo se borra cuando los tests confirmen paridad mínima. | PR2-E2-S1, PR2-E2-S2, PR2-E2-S3, PR2-E2-S4, PR2-E2-S5, PR2-E2-S6, PR2-E2-S7, PR2-E2-S8 | IN_PROGRESS @claude (2026-06-29) — fase 1+2 OK: facade + swap del composition root validados (suite+wiring+funcional verdes, bot corre sobre storage greenfield). Falta SOLO borrar `storage/tracking_repository.py` (después de validar en VPS). |

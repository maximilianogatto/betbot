...
from sandbox.sportradar_http.features_engine import FEATURE_DEFINITIONS, MATCH_FEATURE_DEFINITIONS


DEFAULT_OUT = Path("sandbox/sportradar_http/reports/feature_catalog.md")

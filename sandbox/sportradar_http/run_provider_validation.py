...
from sandbox.sportradar_http.endpoints.discovery import get_config_tree_mini, get_sport_matches_markets
...
from sandbox.sportradar_http.normalizers import normalize_sport_match_markets
...
from sandbox.sportradar_http.run_match_pipeline import build_match_snapshot, fetch_match_payloads
...
from sandbox.sportradar_http.tournament_match_report import build_tournament_match_package, select_fixture
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("sandbox/sportradar_http/examples/provider_validation"))

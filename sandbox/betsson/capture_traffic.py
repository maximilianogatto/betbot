"""Deep network capture for betsson.bet.ar (unknown sportsbook platform).

Loads the site, records every XHR/fetch response, drives the UI a bit
(open football / a league), and dumps interesting bodies for analysis.
...
Run:  ./betbot/bin/python sandbox/betsson/capture_traffic.py
"""
...
START_URL = "https://cba.betsson.bet.ar/apuestas-deportivas"
...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        def on_response(resp):
            ...
            try:
                ...
                if len(body) > 2_000_000:
                    body = body[:2_000_000] + "\n...[TRUNCATED]"
                # capture request headers too (token discovery)
        ...
        # Try to navigate into football / a league. Best-effort selectors.
        for sel in [

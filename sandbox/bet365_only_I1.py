...
async def main():
    if len(sys.argv) < 2:
        print("Uso: python bet365_bootstrap_i1_extract.py <fixture_id> [salida.json]")
        raise SystemExit(1)
    ...
    async with async_playwright() as p:
        ...
        print("→ Extrayendo I1...")
        data = await page.evaluate(EXTRACT_I1_JS)
        ...
        if output_path:
            ...
            print(f"JSON guardado en: {Path(output_path).resolve()}")

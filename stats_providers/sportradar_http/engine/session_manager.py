...
async def bootstrap_sportradar_session(config: BootstrapConfig) -> SportradarSessionState:
    ...
    async with async_playwright() as playwright:
        ...
        context = await playwright.chromium.launch_persistent_context(
            ...
            locale="en-US",
            # Anti-automation hardening so headless Chromium is less likely to be
            # flagged by Akamai (which has returned 403 to vanilla headless here).
            args=[
        ...
        try:
            ...
            # Mask the most common headless tells before any page script runs.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("stats_providers/sportradar_http/engine/reports"))

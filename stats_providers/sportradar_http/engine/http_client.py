    ...
    def get_gismo(
        ...
        *,
        ...
        Args:
            ...
            allow_refresh: When False, a blocked/expired payload never triggers a
                session refresh (bootstrap). Use for optional/live endpoints.
        """
        ...
        return self.request_json("GET", url, allow_refresh=allow_refresh)

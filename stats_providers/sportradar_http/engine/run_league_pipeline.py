...
from stats_providers.sportradar_http.engine.endpoints.tournaments import (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("stats_providers/sportradar_http/engine/examples/league_laliga"))
